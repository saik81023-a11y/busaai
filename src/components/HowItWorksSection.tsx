const steps = [
  ...
  { num: "02", title: "AI Analyses Everything", desc: "Our AI evaluates market data, costs, competition, and opportunities." },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {steps.map((s, i) => (
            <div key={i} className="relative text-center">
              <div className="text-5xl font-bold text-primary/10 mb-3">{s.num}</div>
